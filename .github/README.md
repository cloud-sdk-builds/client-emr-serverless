...
[`@aws-sdk/client-emr-serverless`](https://www.npmjs.com/package/@aws-sdk/client-emr-serverless/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-serverless@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T9Ef6UTbf4s2NVCmryM50dG1opXG89USzZNvEit+4N+O8QbvgBglXameywz+VRO+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-serverless@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-serverless@3.583.0/index.min.mjs": "sha384-T9Ef6UTbf4s2NVCmryM50dG1opXG89USzZNvEit+4N+O8QbvgBglXameywz+VRO+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-serverless/blob/refs/tags/3.583.0/LICENSE
```
